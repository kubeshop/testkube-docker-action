...
RUN if curl -s -f --output /dev/null --connect-timeout 5 https://api.github.com/repos/kubeshop/testkube/releases/latest; \
 ...
 RUN curl -L "https://github.com/kubeshop/testkube/releases/download/v${VERSION}/testkube_${VERSION}_linux_x86_64.tar.gz" | tar -xzvf - \
